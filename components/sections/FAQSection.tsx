...
const faqs: FAQItem[] = [
  ...
  },
  {
    ...
    answer: "Окончательная стоимость открытия и запуска франшизы рассчитывается индивидуально для каждого клиента с учётом выбранного формата, города, объёма инвестиций и дополнительных условий сотрудничества",
    is_open: false
  },  
  {
  ...
  },
  {
    ...
    answer: "Мы предоставим готовые макеты маркетинговых материалов, которые помогут вам эффективно привлекать новых клиентов, повышать узнаваемость бренда и увеличивать продажи с первых дней запуска",
    is_open: false
  },
  {
